...
export const PAGE_META: Record<Page, { title: string; description: string }> = {
    [Page.Home]: {
        title: 'VIMS – Digital Identity, AI Automation & Personal Branding',
        description: 'VIMS helps founders and businesses build authority, automate workflows, and scale revenue through LinkedIn branding, AI automation, digital identity and intelligent voice agents.'
    },
    [Page.LinkedInGrowth]: {
    ...
    [Page.AIAutomation]: {
        title: 'AI Automation Workflows for Business | VIMS',
    ...
    [Page.About]: {
        title: 'About VIMS',
        description: 'Learn about VIMS, our mission to drive digital transformation, and our values of depth, ethical branding, and long-term partnerships.'
    },
    [Page.Contact]: {
    ...
    [Page.TeamProfile]: {
        ...
        description: 'Meet the experts behind VIMS driving digital transformation and AI innovation.'
    }
};
