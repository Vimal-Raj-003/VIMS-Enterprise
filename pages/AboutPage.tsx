        ...
        <>
            ...
            <Section className="bg-navy-light">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-4xl font-poppins font-bold">Our Values</h2>
                    <p className="mt-4 max-w-2xl mx-auto text-lg text-slate-400">The principles that guide every strategy we build and every partnership we form.</p>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    {values.map((value, i) => (
                        <div key={i} className="p-6 text-center bg-slate-900 rounded-3xl border border-slate-800">
            ...
            <Section id="team">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-4xl font-poppins font-bold">Founders & Team</h2>
                </div>
