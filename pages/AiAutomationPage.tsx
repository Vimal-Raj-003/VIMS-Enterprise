        ...
        <>
            ...
            <Section>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    <div>
                        <h2 className="text-3xl font-bold font-poppins mb-4">Our Automation Philosophy</h2>
                        <p className="text-slate-400 mb-6">We believe automation should be custom, pain-point-driven, and seamlessly integrated into your existing processes. Our goal is to save you time, increase revenue, and eliminate manual work so you can focus on what you do best.</p>
                        <div className="space-y-3">
                            <div className="flex items-center"><Zap className="h-5 w-5 text-green mr-2" /><span>Custom workflows designed for your specific needs.</span></div>
                            <div className="flex items-center"><Zap className="h-5 w-5 text-green mr-2" /><span>Integration with your favorite tools (Zoho, HubSpot, etc.).</span></div>
                            <div className="flex items-center"><Zap className="h-5 w-5 text-green mr-2" /><span>Focus on ROI: saving time and increasing revenue.</span></div>
                        </div>
                    </div>
                    <div>
                        <img src="https://picsum.photos/600/400?random=12" alt="Diagram showing interconnected business apps" className="rounded-3xl shadow-2xl shadow-cyan/20" />
                    </div>
                </div>
            </Section>
            ...
            <Section className="bg-navy-light">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-4xl font-poppins font-bold">Automation Solutions Infographic</h2>
                    <p className="mt-4 max-w-2xl mx-auto text-lg text-slate-400">Click on a workflow to see more details.</p>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    {workflows.map((flow, i) => (
                        <div 
                            ...
                            className={`p-6 h-full bg-slate-900 rounded-3xl border transition-all duration-300 cursor-pointer ${
                                selectedWorkflow === i 
            ...
            <Section>
                <div className="bg-slate-900/50 rounded-4xl p-8 md:p-12 border border-slate-800">
                    <h2 className="text-2xl md:text-3xl font-poppins font-bold text-center mb-8">What We Deliver</h2>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="flex items-start space-x-4">
                            <HardHat className="h-8 w-8 text-cyan mt-1 flex-shrink-0" />
                            <div>
                                <h3 className="text-lg font-bold">Workflow Design & Implementation</h3>
                                <p className="text-slate-400">Full design and build of your custom automation workflows in n8n or similar platforms.</p>
                            </div>
                        </div>
                        <div className="flex items-start space-x-4">
                            <Zap className="h-8 w-8 text-cyan mt-1 flex-shrink-0" />
                            <div>
                                <h3 className="text-lg font-bold">API & CRM Integration</h3>
                                <p className="text-slate-400">Seamless connection of your CRM, social media, and other essential business tools.</p>
                            </div>
                        </div>
                         <div className="flex items-start space-x-4">
                            <FileText className="h-8 w-8 text-cyan mt-1 flex-shrink-0" />
                            <div>
                                <h3 className="text-lg font-bold">Documentation & Support</h3>
                                <p className="text-slate-400">Comprehensive documentation and 20 days of post-implementation support to ensure a smooth transition.</p>
                            </div>
                        </div>
                    </div>
                </div>
