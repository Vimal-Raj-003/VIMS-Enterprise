        ...
        <>
            ...
            <Section>
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-4xl font-poppins font-bold">Our Services</h2>
                    <p className="mt-4 max-w-2xl mx-auto text-lg text-slate-400">A complete suite of digital marketing services to elevate your brand.</p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {services.map((service, i) => (
                        <div key={i} className="p-6 h-full bg-slate-900/50 rounded-3xl border border-slate-800">
            ...
            <Section className="bg-navy-light">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    <div>
                        <h2 className="text-3xl font-bold font-poppins mb-4">Strategy is Everything</h2>
                        <p className="text-slate-400 mb-6">We don't just execute tasks; we build comprehensive, data-driven strategies tailored to your specific business goals. Our process begins with a deep dive into your brand, audience, and competitive landscape to create a roadmap for sustainable growth.</p>
                        <ul className="space-y-3">
                            <li className="flex items-start"><Check className="h-5 w-5 text-green mt-1 mr-2 flex-shrink-0" /><span>In-depth Market & Competitor Analysis</span></li>
                            <li className="flex items-start"><Check className="h-5 w-5 text-green mt-1 mr-2 flex-shrink-0" /><span>Customer Persona & Journey Mapping</span></li>
                            <li className="flex items-start"><Check className="h-5 w-5 text-green mt-1 mr-2 flex-shrink-0" /><span>Multi-Channel Content & Distribution Plan</span></li>
                            <li className="flex items-start"><Check className="h-5 w-5 text-green mt-1 mr-2 flex-shrink-0" /><span>KPI & Performance Measurement Framework</span></li>
                        </ul>
                    </div>
                </div>
            </Section>
